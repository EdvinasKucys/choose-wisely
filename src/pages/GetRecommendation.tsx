...
import { ArrowRight, Upload, Camera, Smile, FileText, Check } from "lucide-react";
...
const GetRecommendation = () => {
  ...
  const handleSliderChange = (trait: keyof typeof preferences.personality, value: number[]) => {
    setPreferences(prev => ({
      ...prev,
      personality: {
        ...prev.personality,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-24 pb-16 bg-gradient-to-tr from-[#254441] to-[#7FC8A9]">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-6">Get Personalized Recommendations</h1>
          <p className="text-white/90 max-w-3xl mb-8">
            Let our system analyze your preferences, personality traits, and needs to find the perfect match for you.
          </p>
          ...
          <div className="flex justify-between mb-12 max-w-3xl mx-auto">
            {[1, 2, 3, 4].map((stepNumber) => (
              <div key={stepNumber} className="flex flex-col items-center">
                ...
                <span className={`text-xs mt-2 ${step >= stepNumber ? 'text-white' : 'text-white/70'}`}>
            ...
            {loading && (
              <div className="absolute inset-0 bg-black/20 backdrop-blur-sm flex flex-col items-center justify-center z-10">
                <div className="w-full h-full relative">
                  <div className="scan-line" style={{ top: `${progress}%` }}></div>
                </div>
                <div className="text-white text-xl font-semibold">Analyzing your profile...</div>
            ...
            <div className="p-6 md:p-8">
              ...
              {step === 1 && (
                <div className="space-y-6">
                  ...
                  <p className="text-gray-600">Let's start with some basic information about what you're looking for.</p>
                  
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="category">What category are you interested in?</Label>
                      <Input 
                        id="category" 
                        name="category" 
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      <p className="text-xs text-gray-500">
                        Your photo helps our AI understand your style preferences better.
                        We'll never share your photo with others.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-semibold">Your Personality Profile</h2>
                  <p className="text-gray-600">
                    Adjust the sliders to reflect your personality traits. This helps us make better recommendations.
                  </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Slider 
                        ...
                        max={100} 
                        step={1}
                        onValueChange={(value) => handleSliderChange('neuroticism', value)}
                      />
                    </div>
                  </div>
                </div>
              ...
              {step === 3 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-semibold">Specific Requirements</h2>
                  <p className="text-gray-600">
                  ...
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="requirements">What specific features or requirements are important to you?</Label>
                      <Textarea 
                        id="requirements" 
                        name="requirements" 
              ...
              {step === 4 && (
                <div className="space-y-6">
                  <div className="bg-primary/10 p-4 rounded-none border border-primary/20">
                    <h2 className="text-2xl font-semibold text-primary">Your Personalized Recommendation</h2>
                    <p className="text-gray-600 mt-2">
                      Based on your preferences, personality profile, and requirements, we've found these perfect matches for you.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card className="rounded-none overflow-hidden border border-gray-200">
                      <div className="h-48 bg-gray-200 flex items-center justify-center">
                        <img src="/placeholder.svg" alt="Recommendation" className="h-full w-full object-cover" />
                      </div>
                      <div className="p-4">
                        <h3 className="font-semibold">BMW X3 2020</h3>
                        <p className="text-sm text-gray-600 mt-1">
                          This vehicle matches your practical yet stylish personality, with excellent safety features and the right size for your needs.
                        </p>
                        <p className="font-medium mt-2">€38,500</p>
                        <Button className="w-full mt-3 rounded-none">View Details</Button>
                      </div>
                    </Card>
                    ...
                    <Card className="rounded-none overflow-hidden border border-gray-200">
                      ...
                      <div className="p-4">
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          Perfect balance of luxury and functionality, aligning with your organized and detail-oriented nature.
                        </p>
                  ...
                  <p className="text-center text-sm text-gray-500 mt-4">
                    These recommendations are based on our analysis of your profile and available listings.
                  </p>
                  
                  <div className="flex justify-center mt-6">
                    <Button className="rounded-none">
                      Browse More Recommendations <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                  </div>
                </div>
              )}
              ...
              <div className="flex justify-between mt-10">
                {step > 1 && (
                  <Button variant="outline" className="rounded-none" onClick={prevStep}>
                    Back
                  </Button>
                )}
                ...
                {step === 3 && (
                  <Button className="rounded-none ml-auto" onClick={handleSubmit}>
                    Get Recommendations <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                )}
                
                {step === 4 && (
                  <Button className="rounded-none ml-auto" onClick={() => setStep(1)}>
                    Start New Search
                  </Button>
                )}
              </div>
