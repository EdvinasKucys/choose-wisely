...
import { ArrowRight, User, Mail, Lock, Globe } from "lucide-react";
import { link } from "fs";
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-24 bg-hero-gradient">
        <Card className="w-full max-w-md animate-fade-in glass-card">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Join our platform to start making better decisions
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <Link to="https://www.epaslaugos.lt/portal/">
              <Button variant="outline" className="w-full rounded-none">
                <Globe className="h-4 w-4 mr-2" />
                Register with Lithuanian E-Gov
              </Button>
            </Link>
          </CardContent>
