      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              Making decisions simple and precise through personalized recommendations and intelligent matching.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/get-recommendation" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Recommendations
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <a href="mailto:info@choosewisely.com" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center">
              <Mail className="h-4 w-4 mr-2" /> info@choosewisely.com
            </a>
          </div>
        </div>
      </div>
