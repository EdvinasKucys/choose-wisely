      ...
      <div className="container mx-auto px-4 py-32 sm:py-48 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-slide-up">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
            Let our advanced platform help you make decisions based on your
            appearance, character, and needs. Find the perfect match for your
            lifestyle with personalized recommendations.
          </p>
